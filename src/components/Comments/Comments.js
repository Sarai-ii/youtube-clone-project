...
//           className="w-100"
//           value={comment.name} onChange={handleTextChange} />
          
//           <label htmlFor='comment float'>Comment: </label>
//           <input type='text' id='comment' 
//           className="w-100"
//           value={comment.comment} onChange={handleTextChange} />
          
//           <input type='submit' 
//           className="row comment-button btn btn-outline-secondary-active"
//           value={editComment !== -1 ? 'Update Comment' : 'Comment'} />
//         </form>
//         <hr />
//         <ul>
